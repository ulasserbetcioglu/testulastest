...
import { LogOut, Menu, X, Home, Calendar, FileText, FilePlus, Award, Package, TrendingUp, Grid, Bug, FolderOpen } from 'lucide-react';
...
const BranchLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/branch/faaliyet-dosyasi', icon: <FolderOpen size={20} />, name: 'Faaliyet Dosyası' },
