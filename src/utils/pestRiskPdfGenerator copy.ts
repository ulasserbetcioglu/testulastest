...
function drawDefinitionsAndMatrix(pdf: jsPDF, startY: number, W: number): number {
  ...
  const interpretations = [
    ...
    { r: toAscii('9-15 ORTA AYDA 2 ZİYARET'), bg: [254, 249, 195], t: toAscii('Capraz bulasma kontrol edilmeli. Onlemler alinmali.') },
