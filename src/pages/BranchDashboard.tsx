...
import BranchApprovedPesticidesView from '../components/CriticalLimits/BranchApprovedPesticidesView';
import BranchRodentMonitoringView from '../components/CriticalLimits/BranchRodentMonitoringView';
import BranchPaidMaterials from './BranchPaidMaterials';
            ...
            {branchId && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="bg-gray-50 px-4 py-2 border-b border-gray-200 flex flex-wrap gap-2">
                        ...
                        <button onClick={() => setActiveTab('ipm')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'ipm' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><FileText size={16} /> IPM Sözleşmesi</button>
                        <button onClick={() => setActiveTab('limits')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'limits' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><AlertTriangle size={16} /> Kritik Limitler</button>
                        <button onClick={() => setActiveTab('risk')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'risk' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><Bug size={16} /> Risk Değ.</button>
                        <button onClick={() => setActiveTab('action')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'action' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><CheckCircle size={16} /> Aksiyon Planı</button>
                        <button onClick={() => setActiveTab('env')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'env' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><MapPin size={16} /> Çevre Risk</button>
                        <button onClick={() => setActiveTab('approved_pesticides')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'approved_pesticides' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><Bug size={16} /> Onaylı Pestisit Listesi</button>
                        <button onClick={() => setActiveTab('rodent_monitoring')} className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'rodent_monitoring' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:bg-white'}`}><Bug size={16} /> Kemirgen İzleme</button>
                    </div>
                    ...
                    <div className="p-6 bg-gray-50/30 min-h-[400px]">
                        ...
                        {activeTab === 'materials' && <BranchPaidMaterials />}
                        ...
                        {activeTab === 'ipm' && <BranchIpmView branchId={branchId} />}
                        {activeTab === 'limits' && <BranchPestActivityView branchId={branchId} />}
                        {activeTab === 'risk' && <BranchPestRiskView branchId={branchId} />}
                        {activeTab === 'action' && <BranchActionPlanView branchId={branchId} />}
                        {activeTab === 'env' && <BranchEnvironmentalRiskView branchId={branchId} />}
                        {activeTab === 'approved_pesticides' && <BranchApprovedPesticidesView branchId={branchId} />}
                        {activeTab === 'ipm' && <BranchIpmView branchId={branchId} />}
                        {activeTab === 'limits' && <BranchPestActivityView branchId={branchId} />}
                        {activeTab === 'risk' && <BranchPestRiskView branchId={branchId} />}
                        {activeTab === 'action' && <BranchActionPlanView branchId={branchId} readOnly={true} />}
                        {activeTab === 'env' && <BranchEnvironmentalRiskView branchId={branchId} />}
                        {activeTab === 'rodent_monitoring' && <BranchRodentMonitoringView branchId={branchId} />}
                    </div>
                </div>
            )}
        </div>
