    ...
    <div className="flex h-[calc(100vh-64px)] bg-gray-100 font-sans text-gray-900 overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col print:hidden z-20 shadow-lg">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <button disabled={!selectedBranchId} onClick={() => setActiveTab('4.2')} className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeTab === '4.2' ? 'bg-green-50 text-green-700' : 'text-gray-600 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed'}`}><ClipboardList size={18} /> 4.2 Ekipman Takip</button>
