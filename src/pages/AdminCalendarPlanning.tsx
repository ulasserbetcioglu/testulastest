...
import { format, startOfMonth, endOfMonth, eachDayOfInterval, isToday, addMonths, getDay, isSameDay } from 'date-fns';
import { tr } from 'date-fns/locale';
import { supabase, supabaseAdmin } from '../lib/supabase';
import { 
  Search, Filter, Plus, X, ChevronLeft, ChevronRight, Calendar, Trash2, User, 
  Download, FileImage, FileText, Menu, List, Grid, CheckCircle 
} from 'lucide-react';
              ...
              <div className="bg-white rounded-xl shadow border border-gray-200 overflow-hidden">
                ...
                <div className="grid grid-cols-7 auto-rows-fr bg-gray-200 gap-px border-b">
                  {eachDayOfInterval({ start: startOfMonth(currentDate), end: endOfMonth(currentDate) }).map((day, i) => {
                    // İlk gün boşluklarını ayarla (CSS Grid ile yapmak daha temiz ama JS ile margin de verilebilir)
                    // Burada basitlik için sadece günleri render ediyoruz, ızgara yapısını korumak için boş divler eklenebilir.
                    return (
