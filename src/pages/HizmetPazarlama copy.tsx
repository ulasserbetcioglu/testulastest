    ...
    `;
      ...
      <div class="container">
        ...
        <div class="content">
            ...
            if (item.type === 'service') {
                unitText = item.unitType === 'aylik' ? `Aylık Hizmet` : `Tek Seferlik`;
                // Use the global summer/winter frequency for all service items in this proposal context
                frequencyText = `Yaz: ${summerVisitFrequency} / Kış: ${winterVisitFrequency}`;
            } else {
                unitText = `${count} ${item.unitType || 'Adet'}`;
                frequencyText = '-';
            }
            ...
            return `
                  <tr style="border-bottom: 1px solid #eeeeee;">
                    ...
                    <td style="padding: 15px; font-size: 13px; text-align: center; vertical-align: top; white-space: nowrap; color: #555;">${frequencyText}</td>
                    <td style="padding: 15px; font-size: 13px; text-align: center; vertical-align: top; white-space: nowrap;">${unitText}</td>
                    <td style="padding: 15px; font-size: 14px; text-align: right; vertical-align: top; font-weight: bold;">${price.toLocaleString('tr-TR', { style: 'currency', currency: 'TRY' })}</td>
                  </tr>
                `}).join('')}</tbody>
