  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
        <h1 className="text-xl sm:text-2xl font-bold">Günlük Kontrol Listesi</h1>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 sm:px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm whitespace-nowrap"
          >
            Bugün
          </button>
        </div>
                ...
                <div className="p-4 border-b border-gray-100">
                  ...
                  {visit.branch && (
                    <div className="text-gray-700 flex flex-wrap items-center gap-1">
                      <span>{visit.branch.sube_adi}</span>
                      {visit.branch.latitude && visit.branch.longitude && (
                        <span className="text-green-600 flex items-center text-xs sm:text-sm">
                          <MapPin size={14} className="mr-0.5 shrink-0" />
                          <span className="truncate">{visit.branch.latitude.toFixed(4)}, {visit.branch.longitude.toFixed(4)}</span>
                        </span>
                      )}
                    </div>
                  )}
