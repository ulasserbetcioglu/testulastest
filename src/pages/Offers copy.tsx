...
import { MoreVertical, Plus, Search, Filter, CheckCircle, Clock, XCircle, Trash2, AlertTriangle, Loader2, Eye, Key, Copy, RefreshCcw } from 'lucide-react';
...
const OffersPage: React.FC = () => {
  ...
  // YETKİ STATE'LERİ
  const [userRole, setUserRole] = useState<'admin' | 'operator' | 'customer' | 'branch' | null>(null);
                      ...
                      {isStaff && (
                        <>
                          <button
                            ...
                            className="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-blue-600 hover:bg-blue-50"
                          >
                            <RefreshCcw size={16} /> Revize Et (Kopyala)
                          </button>
                          <button
