...
import { FileText, Download, Eye, Calendar, Filter, X } from 'lucide-react';
...
interface BranchModuleReportsProps {
  branchId: string;
}

const BranchModuleReports: React.FC<BranchModuleReportsProps> = ({ branchId }) => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      // Fetch Risk Assessments for this branch
      ...
      // Fetch Proposals for this branch
      ...
      // Fetch UV Lamp Reports for this branch
      ...
      // Fetch Activity Files for this branch
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Modül Raporları</h2>
        <p className="text-gray-600">Bu şube için oluşturulan tüm modül raporlarını görüntüleyin</p>
      </div>
      ...
      {reports.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm p-12 text-center">
          ...
          <p className="text-gray-600">
            {selectedType === 'all'
              ? 'Bu şube için henüz rapor oluşturulmamış.'
...
export default BranchModuleReports;
