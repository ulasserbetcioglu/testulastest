...
import { MoreVertical, Plus, Search, Filter, CheckCircle, Clock, XCircle, Edit, Trash2, AlertTriangle, FileText, FileImage, Loader2, Eye } from 'lucide-react';
...
interface Proposal {
  ...
  company_name: string; // proposals tablosundaki firma adı
  contact_person: string;
  created_at: string;
  validity_date?: string; // Veritabanında yoksa opsiyonel
...
const OffersPage: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    try {
        // Önce proposal_items silinmeli (Cascade varsa otomatik silinir ama garanti olsun)
            ...
            <div key={proposal.id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="p-5 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div className="md:col-span-4">
                  <p className="font-semibold text-green-700 text-sm">#{proposal.proposal_number}</p>
                ...
                <div className="md:col-span-3 text-sm text-gray-600">
                  ...
                  {/* Geçerlilik tarihi veritabanında varsa ekleyin */}
                </div>
