...
import { Loader2 as Loader, FileDown, Check, X, KeyRound, Printer, Shield, Bug, Package, FileSignature, FileText, Eye, ArrowLeft } from 'lucide-react';
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '30px' }}>
                            <thead>
                                <tr style={{ borderBottom: `2px solid ${primaryColor}` }}>
                                    ...
                                    {proposal.show_visit_frequency !== false && (
                                        <th style={{ padding: '10px 0', textAlign: 'center', fontSize: '10px', fontWeight: '700', color: primaryColor, textTransform: 'uppercase', width: '20%' }}>ZİYARET SIKLIĞI</th>
                                    )}
                            ...
                            <tbody>
                                {proposal.proposal_items.map((item, index) => {
                                    ...
                                    if (isProduct) {
                                        ...
                                        unitText = item.unit_type === 'seferlik' ? 'Tek Sefer' : `Aylık Hizmet`;
                                        frequencyText = `Yaz: ${proposal.summer_visit_frequency || 1} / Kış: ${proposal.winter_visit_frequency || 1}`;
                                    }
