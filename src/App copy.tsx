...
import AdminParasutMapping from './pages/AdminParasutMapping';
import SurveyPage from './pages/SurveyPage';
import ParasutSettings from './pages/ParasutSettings';
import AdminReconciliation from './pages/AdminReconciliation';
import AdminReconciliationResponses from './pages/AdminReconciliationResponses';
import ConfirmReconciliation from './pages/ConfirmReconciliation';
import IncompleteVisits from './pages/IncompleteVisits';
    ...
    <Router>
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route path="/mutabakat-onay" element={<ConfirmReconciliation />} />
          ...
          <Route path="/operator/*" element={<ProtectedRoute><OperatorLayout /></ProtectedRoute>}>
            ...
            <Route path="musteri-kayitlari" element={<CustomerLeads />} />
          </Route>
          ...
          <Route path="/*" element={<ProtectedRoute><RoleBasedRoute><Layout /></RoleBasedRoute></ProtectedRoute>}>
            ...
            <Route path="admin/parasut-eslestirme" element={<AdminRoute><AdminParasutMapping /></AdminRoute>} />
            <Route path="admin/parasut-ayarlari" element={<AdminRoute><ParasutSettings /></AdminRoute>} />
            <Route path="admin/mutabakat" element={<AdminRoute><AdminReconciliation /></AdminRoute>} />
            <Route path="admin/mutabakat-yanitlari" element={<AdminRoute><AdminReconciliationResponses /></AdminRoute>} />
            <Route path="dof" element={<CorrectiveActions />} />
            <Route path="sozlesmeler" element={<Sozlesmeler />} />
            <Route path="egitim-sunumlari" element={<TrainingPresentationPage />} />

            <Route path="admin/monthly-visit-schedule" element={<AdminRoute><AdminMonthlyVisitSchedule /></AdminRoute>} />
            <Route path="admin/eksik-ziyaretler" element={<AdminRoute><IncompleteVisits /></AdminRoute>} />
            ...
            <Route path="tahminleme" element={<AdminRoute><AdminPredictiveAnalytics /></AdminRoute>} />
            <Route path="musteri-kayitlari" element={<CustomerLeads />} />
          </Route>
        </Routes>
      </AuthProvider>
